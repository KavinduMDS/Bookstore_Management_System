    ...
    <div class="container">
        <div class="sidebar">
            <ul>
                ...
                <li><a href="orderview/employee_order.php">Order Check</a></li>
                <li><a href="message_customer/index.php">MESSAGES</a></li>
                <li><a href="staff_config/index.php">Staff Configuration</a></li>
            </ul>
        </div>
